...
module.exports = function(app) {
  ...
  return {
    start: function() {
      ...
      app.use('/plugins/main.js', express.static(path.join(__dirname, '/../../plugin-config/public/main.js')));

      app.use('/plugins/configure', (req, res, next) => {
        res.render('plugins', {scripts: ['main.js']})
      })
